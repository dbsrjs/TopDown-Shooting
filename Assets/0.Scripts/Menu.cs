...
public class Menu : MonoBehaviour
{
    ...
    public GameObject playMenuHolder;       //플레이 메뉴 오브젝트
    ...
    int activeScreenResIndex;                //활성 해상도 인덱스
    ...
    public void Quit()
    {
        ...
        UnityEditor.EditorApplication.isPlaying = false;    //게임 중지 기능 활성화
#endif
